 ...
 */
public class RpcRequest extends RequestMessage {

    public final long requestId;

    public RpcRequest(long requestId, ManagedBuffer buffer) {
        super(buffer);
    ...
    public static RpcRequest decode(ByteBuf buf) {
        ...
        buf.readInt();
        return new RpcRequest(requestId, new NioManagedBuffer(buf.nioBuffer()));
    }
